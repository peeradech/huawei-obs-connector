...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("HuaweiOBSConnector.ExplorerDocument", mendixObject.getType()))
			return huaweiobsconnector.proxies.ExplorerDocument.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("AmazonS3Connector.ExplorerDocument", mendixObject.getType()))
