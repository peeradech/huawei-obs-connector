...
public class AwsConfig
{
	 ...
	 */
	public static final java.lang.String entityName = "AmazonS3Connector.AwsConfig";
	...
	public enum MemberNames
	{
		...
		AccessKey("AccessKey"),
		SecretKey("SecretKey"),
		SelectedRegion("AmazonS3Connector.SelectedRegion");
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "AmazonS3Connector.AwsConfig"));
	}
	...
	protected AwsConfig(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject awsConfigMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("AmazonS3Connector.AwsConfig", awsConfigMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a AmazonS3Connector.AwsConfig");
	...
	public static amazons3connector.proxies.AwsConfig initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
	 ...
	 */
	public static amazons3connector.proxies.AwsConfig initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new amazons3connector.proxies.AwsConfig(context, mendixObject);
	}

	public static amazons3connector.proxies.AwsConfig load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return amazons3connector.proxies.AwsConfig.initialize(context, mendixObject);
	}

	public static java.util.List<amazons3connector.proxies.AwsConfig> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<amazons3connector.proxies.AwsConfig> result = new java.util.ArrayList<amazons3connector.proxies.AwsConfig>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//AmazonS3Connector.AwsConfig" + xpathConstraint))
	 ...
	 */
	public final amazons3connector.proxies.Region getSelectedRegion() throws com.mendix.core.CoreException
	{
	 ...
	 * @return value of SelectedRegion
	 */
	public final amazons3connector.proxies.Region getSelectedRegion(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		amazons3connector.proxies.Region result = null;
		...
		if (identifier != null)
			result = amazons3connector.proxies.Region.load(context, identifier);
		return result;
	}
	 ...
	 */
	public final void setSelectedRegion(amazons3connector.proxies.Region selectedregion)
	{
	 ...
	 * @param selectedregion
	 */
	public final void setSelectedRegion(com.mendix.systemwideinterfaces.core.IContext context, amazons3connector.proxies.Region selectedregion)
	{
